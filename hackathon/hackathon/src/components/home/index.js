...
function Home() {
  useEffect(() => {
    ...
    var w = (c.width = window.innerWidth),
      h = (c.height = window.innerHeight/1.13),
      ctx = c.getContext("2d"),
      opts = {
        range: 1000,
        baseConnections: 3,
  ...
  return (
    <section className="overflow-hidden bg-[#e8ded5]">
      <Navbar />
      {/* <div className="object-fill ">
      <img className="w-full" src="/assets/images/hero.png" alt="hero" />
    </div> */}
      <canvas id="c"></canvas>
      <div className="grid grid-cols-2">
        <div className="px-14 py-10 grid place-content-center">
          <h1 className="text-4xl font-semibold  text-green-700 pb-4">
            About Our Project
          </h1>
          <p className="text-xl font-normal text-justify">
            The main objective of our project is to predict the new drugs and,
            delivering end-to-end solutions with data-driving insights that
            advance healthcare and improve lives every day.
          </p>
        </div>
        ...
        <ol class="relative border-l border-gray-200 dark:border-gray-700">
          <li class="mb-10 ml-4">
            ...
            <h3 class="text-lg font-semibold text-black">
              Carboplatin is a alkylating agent used to treat advanced ovarian
              cancer.
            </h3>
            <a
              href="/drug/carboplatin"
          ...
          <li class="mb-10 ml-4">
            ...
            <h3 class="text-lg font-semibold text-black">
              Remdesivir is a nucleoside analog used to treat RNA virus
              infections including COVID-19.
            </h3>
            <a
              href="/drug/remedesivir"
              class="inline-flex items-center py-2 px-4 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"
            >
              Learn more{" "}
              <svg
          ...
          <li class="mb-10 ml-4">
            ...
            <h3 class="text-lg font-semibold text-black">
              Gemcitabine is a nucleoside metabolic inhibitor used as adjunct
              therapy in the treatment of certain types of ovarian cancer,
              non-small cell lung carcinoma, metastatic breast cancer, and as a
              single agent for pancreatic cancer.
            </h3>
            <a
              href="/drug/gemitabine"
              class="inline-flex items-center py-2 px-4 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"
            >
              Learn more{" "}
              <svg
          ...
          <li class="mb-10 ml-4">
            ...
            <h3 class="text-lg font-semibold text-black">
              ...
              (SNRI) used in the management of Attention Deficit Hyperactivity
              Disorder (ADHD).
            </h3>
            <a
              href="/drug/atomoxetine"
              class="inline-flex items-center py-2 px-4 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"
            >
              Learn more{" "}
              <svg
          ...
          <li class="mb-10 ml-4">
            ...
            <h3 class="text-lg font-semibold text-black">
              Ciprofloxacin is a second generation fluoroquinolone used to treat
              various susceptible bacterial infections.
            </h3>
            <a
              href="/drug/ciprofloxacin"
              class="inline-flex items-center py-2 px-4 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"
            >
              Learn more{" "}
              <svg
